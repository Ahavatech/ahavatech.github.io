...
const baseURL = import.meta.env.VITE_API_BASE_URL; // Adjust this based on your environment setup
...
export const CourseMaterialUpload: React.FC<CourseMaterialUploadProps> = ({
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      const response = await fetch('https://oplayeni.onrender.com/api/materials/upload', { 
        method: 'POST',
        body: formData,
      });
