...
export function ProfileForm() {
  ...
  const profileQuery = useQuery<Profile>({
    ...
    queryFn: async () => {
      const response = await apiRequest("GET", "https://oplayeni.onrender.com/api/profile");
  ...
  const updateProfileMutation = useMutation({
    mutationFn: (data: typeof formData) => 
      apiRequest("PUT", "https://oplayeni.onrender.com/api/profile", data),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["https://oplayeni.onrender.com/api/profile"] });
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      const response = await apiRequest("PUT", "https://oplayeni.onrender.com/api/profile/upload-photo", formData, { isFormData: true });
