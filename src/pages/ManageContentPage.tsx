...
export function ManageContentPage({ isAdmin }: ManageContentPageProps) {
  ...
  const fetchContent = async () => {
    try {
      ...
      const [publicationsRes, talksRes] = await Promise.all([
        fetch('https://oplayeni.onrender.com/api/publications'),
        fetch('https://oplayeni.onrender.com/api/talks')
      ]);
  ...
  const handleTalkSubmit = async (formData: FormData) => {
    try {
      const url = editingTalk 
        ? `https://oplayeni.onrender.com/api/talks/${editingTalk._id}`
        : 'https://oplayeni.onrender.com/api/talks';
  ...
  const handleDeleteTalk = async (id: string) => {
    ...
    try {
      const response = await fetch(`https://oplayeni.onrender.com/api/talks/${id}`, { 
        method: 'DELETE'
      });
