...
export default function AdminPage() {
  ...
  const coursesQuery = useQuery<Course[]>({
    queryKey: ["https://oplayeni.onrender.com/api/courses"],
    queryFn: async () => {
      const response = await apiRequest("GET", "https://oplayeni.onrender.com/api/courses");
      return response.json();
    },
  });

  const publicationsQuery = useQuery<PublicationWithId[]>({
    queryKey: ["https://oplayeni.onrender.com/api/publications"],
    queryFn: async () => {
      const response = await apiRequest("GET", "https://oplayeni.onrender.com/api/publications");
      return response.json();
    },
  });
  ...
  const eventsQuery = useQuery({
    queryKey: ['events'],
    queryFn: async () => {
      const response = await fetch('https://oplayeni.onrender.com/api/events');
      if (!response.ok) {
  ...
  const deleteMutation = useMutation({
    mutationFn: (courseId: string) => 
      apiRequest("DELETE", `https://oplayeni.onrender.com/api/courses/${courseId}`),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["https://oplayeni.onrender.com/api/courses"] });
  ...
  const deletePublicationMutation = useMutation({
    mutationFn: async (id: string) => {
      ...
      try {
        const response = await apiRequest("DELETE", `https://oplayeni.onrender.com/api/publications/${id}`);
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: ["https://oplayeni.onrender.com/api/publications"] });
                            ...
                            try {
                              ...
                              console.log("[Publication Form] Sending request:", {
                                ...
                                url: editingPublication._id ? 
                                  `https://oplayeni.onrender.com/api/publications/${editingPublication._id}` : 
                                  'https://oplayeni.onrender.com/api/publications',
                ...
                <div className="rounded-xl border bg-card text-card-foreground shadow-lg">
                  <div className="p-8">
                    ...
                    <EventList 
                      ...
                      onDelete={async (id) => {
                        try {
                          const response = await fetch(`https://oplayeni.onrender.com/api/events/${id}`, {
                            method: 'DELETE',
                          });
                          if (!response.ok) {
