...
export default function CourseDetailPage() {
  ...
  const courseQuery = useQuery<Course>({
    queryKey: ["https://oplayeni.onrender.com/api/courses", id],
    queryFn: async () => {
      const response = await apiRequest("GET", `https://oplayeni.onrender.com/api/courses/${id}`);
      return response.json();
    },
  });

  const materialsQuery = useQuery<CourseMaterial[]>({
    queryKey: ["https://oplayeni.onrender.com/api/courses", id, "materials"],
    queryFn: async () => {
      const response = await apiRequest("GET", `https://oplayeni.onrender.com/api/courses/${id}/materials`);
      return response.json();
    },
  });
  ...
  const updateCourseMutation = useMutation({
    mutationFn: async (data: Partial<Course>) => {
      const response = await apiRequest("PUT", `https://oplayeni.onrender.com/api/courses/${id}`, data);
      return response.json();
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["https://oplayeni.onrender.com/api/courses", id] });
  ...
  const deleteMaterialMutation = useMutation({
    mutationFn: (materialId: string) => 
      apiRequest("DELETE", `https://oplayeni.onrender.com/api/materials/${materialId}`),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["https://oplayeni.onrender.com/api/courses", id, "materials"] });
